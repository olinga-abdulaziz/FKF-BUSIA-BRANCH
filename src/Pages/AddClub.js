            ...
            <form className='clubForm'>
                ...
                <hr />
                    <div className="form-group">
                      ...
                      <input value={clubname} type="text" className="form-control" name="clubname" id="clubname" aria-describedby="helpId"  onChange={(event=>setclubname(event.target.value))} />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="file" 
                        className="form-control" name="badge" id="badge" aria-describedby="helpId" placeholder="" />
                    </div>
                    <div className="form-group">
                      <label for="" className='text-muted'>Location/Home</label>
                      <input value={home} type="text" className="form-control" name="home" id="home" aria-describedby="helpId" placeholder="" onChange={(event=>sethome(event.target.value))}/>
                    </div>
                    <div className="form-group">
                      <label for="" className='text-muted'>Stadium</label>
                      <input value={stadium} type="text" className="form-control" name="stadium" id="stadium" aria-describedby="helpId" placeholder="" onChange={(event=>setstadium(event.target.value))}/>
                    </div>
                    <div className="form-group">
                      <label for="" className='text-muted'>Description</label>
                      <textarea value={description} className="form-control" name="description" id="description" rows="3" onChange={(event=>setdescription(event.target.value))}></textarea>
                    </div>
                    <input name="" id="" className="btn btn-primary form-control" type="button" value={btnsubmit} onClick={submitForm}/>
            </form>
